...
module canonical-indeterminate-forms where
  ...
  canonical-indeterminate-forms-base (TAFst wt) (IFst ind h1) = CIFBFst (_ , _ , refl , wt , ind , h1)
  canonical-indeterminate-forms-base (TASnd wt) (ISnd ind h1) = CIFBSnd (_ , _ , refl , wt , ind , h1)
  ...
  canonical-indeterminate-forms-arr (TAFst wt) (IFst ind h1) = CIFAFst (_ , _ , refl , wt , ind , h1)
  canonical-indeterminate-forms-arr (TASnd wt) (ISnd ind h1) = CIFASnd (_ , _ , refl , wt , ind , h1)
  ...
  canonical-indeterminate-forms-hole (TAFst wt) (IFst ind h1) = CIFHFst (_ , _ , refl , wt , ind , h1)
  canonical-indeterminate-forms-hole (TASnd wt) (ISnd ind h1) = CIFHSnd (_ , _ , refl , wt , ind , h1)
  ...
  canonical-indeterminate-forms-prod (TACast wt x) (ICastProd x₁ ind ne) = CIFPCast (_ , _ , _ , _ , _ , refl , wt , ne , ind , x₁)
  ...
  canonical-indeterminate-forms-prod (TAFst wt) (IFst ind h1) = CIFPFst (_ , _ , refl , wt , ind , h1)
  canonical-indeterminate-forms-prod (TASnd wt) (ISnd ind h1) = CIFPSnd (_ , _ , refl , wt , ind , h1)
  ...
  canonical-indeterminate-forms-coverage {τ = τ ⊗ τ₁} (TACast wt x) (ICastProd x₁ ind _) nb na nh np = np τ τ₁ refl
